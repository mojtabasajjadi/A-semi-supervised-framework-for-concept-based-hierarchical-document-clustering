...
class BOCModel():
    ...
    def __init__(self, doc_path=None, model_path=None, embedding_dim=400, 
        context=4, min_freq=50, num_concept=400, iterations=5):
...
def _save_boc(filepath, boc, idx2word, wv_cluster_id):
    ...
    with open(filepath+'/word2context.txt', 'w',encoding='utf-8') as f:
